...
const FromServiceAdd = ({arrivalOpen, setArrivalOpen, arrivalDate, setArrivalDate, delieveryOpen, setDelieveryOpen, delieveryDate, setDelieveryDate, job_id, onAdd}: {
    arrivalOpen: boolean,
     ...
     <DialogContent className="min-w-fit">
           <form onSubmit={onAdd}>
            ...
            <div className="grid gap-4 py-2">
                <input name="job_id" defaultValue={job_id} hidden/>
                ...
                <div className="flex gap-x-2">
                    ...
                    <Input id="cost" type="number" name="cost" placeholder="ادخل التكلفة" />
                </div>
                <div className="flex gap-x-2">
